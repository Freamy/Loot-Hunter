...
public class ZombieWraithOrange extends Actor {
	
	public ArrayList<Texture> self = loadTextures("graphics/actors/ZombieWraithOrange", "png", true);

	public ZombieWraithOrange(int x, int y) {
		super(x, y);
