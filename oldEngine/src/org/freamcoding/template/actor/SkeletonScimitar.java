...
public class SkeletonScimitar extends Actor {
	
	public ArrayList<Texture> self = loadTextures("graphics/actors/SkeletonScimitar", "png", true);

	public SkeletonScimitar(int x, int y) {
		super(x, y);
