...
public class SkeletalWraithGrey extends Actor {
	
	public ArrayList<Texture> self = loadTextures("graphics/actors/SkeletalWraithGrey", "png", true);

	public SkeletalWraithGrey(int x, int y) {
		super(x, y);
