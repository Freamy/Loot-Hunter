...
public class SkeletonMace extends Actor {
	
	public ArrayList<Texture> self = loadTextures("graphics/actors/SkeletonMace", "png", true);

	public SkeletonMace(int x, int y) {
		super(x, y);
