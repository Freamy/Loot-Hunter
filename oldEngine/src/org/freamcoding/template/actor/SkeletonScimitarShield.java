...
public class SkeletonScimitarShield extends Actor {
	
	public ArrayList<Texture> self = loadTextures("graphics/actors/SkeletonScimitarAndShield", "png", true);

	public SkeletonScimitarShield(int x, int y) {
		super(x, y);
