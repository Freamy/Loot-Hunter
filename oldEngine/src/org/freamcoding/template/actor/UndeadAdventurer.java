...
public class UndeadAdventurer extends Actor {
	
	public ArrayList<Texture> self = loadTextures("graphics/actors/UndeadAdventurer", "png", true);

	public UndeadAdventurer(int x, int y) {
		super(x, y);
